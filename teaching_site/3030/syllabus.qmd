...
**Professor:** Riley Mulhern \| [riley.mulhern\@colorado.edu](mailto:riley.mulhern@colorado.edu)

-   **Office hours:** Thursdays [by appointment](https://zcal.co/rmulherncu/officehrs) \| SEEC S237A
...
-   **Research methods developed**: Qualitative diary methods

-   **Due dates:**

    -   Individual Reflection: Sunday, February 15 by midnight

    -   Group Synthesis: Sunday, February 22 by midnight

#### Assignment #2: Human-Environment Systems Lesson \[Group\]

Working in groups of 3-4, you will select an example of a coupled human-environment system that influences human health or well being and develop a 20 minute lesson for the class on the topic. You and your group will then use concepts from **systems analysis** to teach the class about your selected topic. You will be required to define learning objectives for the class, review the science on the topic, and connect the topic to systems concepts and frameworks covered in class. Your group will sign up for teaching slots during regular class time and submit your slides and teaching materials for grading.

-   **Research methods developed**: Systems analysis

-   **Due date:** Rolling, sign up for presentation days [here](https://o365coloradoedu-my.sharepoint.com/:x:/g/personal/rimu9311_colorado_edu/IQBaMQRWwZ8RTaWSlAR8TF3JAab1aK13J9NNBxHt9exzhW8).

#### Assignment #3: Environmental Health Policy Analysis \[Group\]

Working in groups of 3-4, you will research an environmental health decision, regulation, or policy of your choice. This can be related to anything that we cover in the class (for example air or water quality, ecosystem health, energy production, access to green space, etc.). As a group, you will first submit a project proposal for which policy you plan to study. You will then use established methods of **stakeholder mapping** and **process tracing** to analyze the effectiveness of the policy/intervention and how/why it worked or not, culminating in a final report and poster presentation for the class.
...
+==============================================================================================+======================+==================+=========+
| ##### **Informed Participation**                                                             | ##### **50 points**  | ##### **25%**    |         |
+----------------------------------------------------------------------------------------------+----------------------+------------------+---------+
...
+----------------------------------------------------------------------------------------------+----------------------+------------------+---------+
| ##### **Assignment 1: Environmental Health Diary Study**                                     | ##### **30 points**  | ##### **15%**    |         |
+----------------------------------------------------------------------------------------------+----------------------+------------------+---------+
...
+----------------------------------------------------------------------------------------------+----------------------+------------------+---------+
| ##### **Assignment 2: Human-Environmental Systems Lesson**                                   | ##### **25 points**  | ##### **12.5%**  |         |
+----------------------------------------------------------------------------------------------+----------------------+------------------+---------+
| ##### **Assignment 3: Environmental Health Policy Analysis**                                 | ##### **35 points**  | ##### **17.5%**  |         |
+----------------------------------------------------------------------------------------------+----------------------+------------------+---------+
